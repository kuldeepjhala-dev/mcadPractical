package com.kuldeepjhala.practical5;
...
import com.kuldeepjhala.practical5.databinding.ActivityMainBinding;
...
ActivityMainBinding activityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityMainBinding.login.setOnClickListener(l -> {
                    if (emailid.equals(usernameEditText) && password.equals(passwordEditText)) {
